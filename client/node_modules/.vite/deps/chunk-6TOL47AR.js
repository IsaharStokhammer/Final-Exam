...
function createContainer(options = {}) {
  ...
  const Container2 = React8.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime5.jsx)(ContainerRoot, {
        as: component,
        ownerState,
...
var defaultGenerator3 = (componentName) => componentName;
var createClassNameGenerator3 = () => {
...
var ClassNameGenerator3 = createClassNameGenerator3();
...
function DefaultPropsProvider({
  ...
  return (0, import_jsx_runtime8.jsx)(PropsContext.Provider, {
    value,
    children
  });
}
...
true ? ThemeProvider2.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]).isRequired,
  /**
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React33.Fragment, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    colorSchemeNode: import_prop_types15.default.any,
    /**
     * localStorage key used to store `colorScheme`
     */
    colorSchemeStorageKey: import_prop_types15.default.string,
    /**
     * The default mode when the storage is empty,
     * require the theme to have `colorSchemes` with light and dark.
     */
    defaultMode: import_prop_types15.default.string,
    /**
     * If `true`, the provider creates its own context and generate stylesheet as if it is a root `CssVarsProvider`.
     */
    disableNestedContext: import_prop_types15.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types15.default.bool,
    /**
     * Disable CSS transitions when switching between modes or color schemes.
     */
    disableTransitionOnChange: import_prop_types15.default.bool,
    /**
     * The document to attach the attribute to.
     */
    documentNode: import_prop_types15.default.any,
    /**
     * The key in the local storage used to store current color scheme.
     */
    modeStorageKey: import_prop_types15.default.string,
    /**
     * If `true`, the mode will be the same value as the storage without an extra rerendering after the hydration.
     * You should use this option in conjuction with `InitColorSchemeScript` component.
     */
    noSsr: import_prop_types15.default.bool,
    /**
     * The window that attaches the 'storage' event listener.
     * @default window
     */
    storageWindow: import_prop_types15.default.any,
    /**
...
function isMuiElement2(element, muiNames) {
  var _a, _b, _c;
  return React34.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React35.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React35.Children.map(children, (child) => {
        var _a;
        if (React35.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
function deepClone2(source) {
  if (React37.isValidElement(source) || !isPlainObject3(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge3(target, source, options = {
  ...
  if (isPlainObject3(target) && isPlainObject3(source)) {
    Object.keys(source).forEach((key) => {
      if (React37.isValidElement(source[key])) {
        output[key] = source[key];
...
The color object needs to have a \`main\` property or a \`${mainShade}\` property.` : formatMuiErrorMessage3(11, name ? ` (${name})` : "", mainShade));
    }
...
} });` : formatMuiErrorMessage3(12, name ? ` (${name})` : "", JSON.stringify(color2.main)));
    }
...
function createThemeNoVars(options = {}, ...args) {
  ...
  if (options.vars) {
    throw new Error(true ? "MUI: `vars` is a private field used for CSS variables support.\nPlease use another name." : formatMuiErrorMessage3(20));
  }
...
function createThemeWithVars(options = {}, ...args) {
  ...
  if (!defaultScheme) {
    throw new Error(true ? `MUI: The \`colorSchemes.${defaultColorScheme}\` option is either missing or invalid.` : formatMuiErrorMessage3(21, defaultColorScheme));
  }
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6TOL47AR.js.map
