...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react3.Children.map(children2, function(c) {
    return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react3.isValidElement)(child)) return;
...
//# sourceMappingURL=chunk-UW3LPKH7.js.map
